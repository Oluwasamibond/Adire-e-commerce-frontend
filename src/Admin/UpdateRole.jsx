...
import { fetchUserDetails, removeErrors, removeSuccess, updateUserRole } from "../features/Admin/adminSlice";
...
function UpdateRole() {
  ...
  useEffect(() => {
    if(success){
      toast.success("User Role Updated Successfuly", {position: 'top-center', autoClose:3000})
